                ...
                if (StatusBarRootModernization.isEnabled) {
                    ...
                    launch {
                        clockState.collect { state ->
                            ...
                            leftClock.setVisibleByModernization(showClock && activeClock === leftClock)
                            centerClock.setVisibleByModernization(showClock && activeClock === centerClock)
                            rightClock.setVisibleByModernization(showClock && activeClock === rightClock)
                        }
                    }

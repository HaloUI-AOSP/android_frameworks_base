...
private constructor(
    ...
    inner class PhoneStatusBarBurnInProtectionHandler {
        private var mStatusBarStartSideContent = mView.findViewById<View>(R.id.status_bar_start_side_content)

        private var mStatusBarEndSideContent = mView.findViewById<View>(R.id.status_bar_end_side_content)

...
public class KeyStore2 {
    ...
    public KeyDescriptor grant(KeyDescriptor descriptor, int granteeUid, int accessVector)
        ...
        KeyDescriptor hooked = KeyboxImitationHooks.onGrant(descriptor, granteeUid, accessVector);
        if (hooked != null) return hooked;
    ...
    public void ungrant(KeyDescriptor descriptor, int granteeUid)
        ...
        boolean hooked = KeyboxImitationHooks.onUngrant(descriptor, granteeUid);
        if (hooked) return;

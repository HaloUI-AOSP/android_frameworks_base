/*
 * Copyright (C) 2021-2026 The Android Open Source Project
 *
...
public final class SamsungHooks {
    ...
    public static void initApplicationBeforeOnCreate(Context context) {
        ...
        if (TextUtils.isEmpty(packageName) || TextUtils.isEmpty(Application.getProcessName())) {
            return;
        }

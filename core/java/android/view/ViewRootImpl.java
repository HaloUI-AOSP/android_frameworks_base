...
public final class ViewRootImpl implements ViewParent,
    ...
    final class SyntheticTouchKeypadHandler extends Handler {
        ...
        public void process(MotionEvent event) {
            final int mNoHitYThreshold = 100;
            final int mNoHitMaxTime = 70;
            final int mNoHitFlingVelocity = 1000;
        ...
        private void consumeMovement(long time, float deltaX, float deltaY, int metaState) {
            final float SCROLL_FACTOR = 0.01f;
        ...
        private final Runnable mFlingRunnable = new Runnable() {
            @Override
            public void run() {
                final float FLING_FACTOR = 1/1300f;
                final float FLING_TICK_DECAY = 0.995f;
